        ...
        >
                  ...
                  <div className="column">
                    <div className="box has-text-centered">
                      ...
                      <h6
                        ...
                        title={props.d3mAdaiAdjustment}
                      >
                        Adjustment:{" "}
                        {formatAmount.format(props.d3mAdaiAdjustment)}
                      </h6>
                    </div>
                  </div>
                  <div className="column">
                    <div className="box has-text-centered">
                      <h3
                        className="title"
                        title={props.d3mAdaiAvailableLiquidity}
                      >
                  ...
                  <div className="column">
                    <div className="box has-text-centered">
                      ...
                      <h6 className="title subtitle is-size-6">
                        Variable Debt:{" "}
                        {formatAmount.format(props.d3mAdaiTotalSupplyVariable)}
                      </h6>
                      <h6 className="title subtitle is-size-6">
                        Stable Debt:{" "}
                        {formatAmount.format(props.d3mAdaiTotalSupplyFixed)}
                      </h6>
                    </div>
                  </div>
                  <div className="column">
                    <div className="box has-text-centered">
                      ...
                      <h4 className="title subtitle is-size-4">
                        aDAI Target Interest Rate
                      </h4>
                      <h6
                        className="title subtitle is-size-6"
                        title={props.d3mAdaiFeesPending}
                      >
                        Fees Pending:{" "}
                        {formatAmount.format(props.d3mAdaiFeesPending)}
                      </h6>
                      <h6
                        className="title subtitle is-size-6"
                        title={props.d3mAdaiIncentive}
                      >
                        Incentive Balance:{" "}
                        {formatAmount.format(props.d3mAdaiIncentive)} stkAAVE
                      </h6>
                    </div>
                  </div>
                </div>
                <div className="columns">
                  ...
                  <div className="column">
                    <div className="box has-text-centered">
                      <h3
                        className="title"
                        title={props.d3mAdaiVariableBorrowAPR}
                      >
                  ...
                  <div className="column">
                    <div className="box has-text-centered">
                      <h3
                        className="title"
                        title={props.d3mAdaiStableBorrowAPR}
                      >
                        {formatPercent.format(props.d3mAdaiStableBorrowAPR)}
                      </h3>
                      <h4 className="title subtitle is-size-4">
                        Stable Borrow Rate (APR)
                      </h4>
                    </div>
                  </div>
                </div>
          ...
          <TabPanel>
            ...
            <div className="columns">
              ...
              <Pip
                {...props}
                token="USDC, TUSD, USDP, GUSD, aDAI"
                ilk="USDC-A"
                formater={formatCurrency}
              />
            </div>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    {t("daistats.lot")}:{" "}
                    {formatAmount.format(props.surplusBump)} Lid:{" "}
                    {formatAmount.format(props.flapLid)}
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.flapFill}
                  >
            ...
            <div className="columns">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpStart}
                  >
                    Start: {formatNoDecimals.format(props.lerpHumpStart)}
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpCurrent}
                  >
                    Value: {formatNoDecimals.format(props.lerpHumpCurrent)}
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpEnd}
                  >
                    End: {formatNoDecimals.format(props.lerpHumpEnd)}
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpStartTime}
                  >
                    Start Date: {props.lerpHumpStartTime}
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpDuration}
                  >
                    Duration:{" "}
                    {formatAmount.format(props.lerpHumpDuration / 86400)} Days
                  </p>
                  <p
                    className="title subtitle is-size-6"
                    title={props.lerpHumpAdjustment}
                  >
                    Pending Change:{" "}
                    {formatNoDecimals.format(props.lerpHumpAdjustment)}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="subtitle is-size-6">
                    ({t("daistats.dai_brewing")}:{" "}
                    {formatAmount.format(props.daiBrewing)})
                  </p>
                </div>
              </div>
              <div className="column">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="title subtitle is-size-4">
                    <a
                      href={`https://etherscan.io/token/${props.BKR}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
          ...
          <TabPanel>
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.GOV_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.RISK_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.GRO_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.IN_WALLET}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Data Insights Core
                      Unit
                    </h3>
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.COM_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Governance
                      Communications Core Unit
                    </h3>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.RWF_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.CP_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Content Production
                      Unit
                    </h3>
                    <p className="subtitle is-size-7">{props.CP_MULTISIG}</p>
                  </a>
                  <a
                    href={`https://etherscan.io/address/${props.CP_MULTISIG_2}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Sustainable Ecosystem
                      Scaling Core Unit (SES)
                    </h3>
                    <p className="subtitle is-size-7">
                      {props.SES_AUDITORS_MULTISIG}
                    </p>
                  </a>
                </div>
              </div>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    ...
                    <p className="subtitle is-size-7">
                      {props.SES_PERMANENT_TEAM_MULTISIG}
                    </p>
                  </a>
                </div>
              </div>
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> SES Incubation
                      Program
                    </h3>
                    <p className="subtitle is-size-7">
                      {props.SES_INCUBATION_PROGRAM_MULTISIG}
                    </p>
                  </a>
                </div>
              </div>
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    ...
                    <p className="subtitle is-size-7">
                      {props.SES_GRANTS_PROGRAM_MULTISIG}
                    </p>
                  </a>
                </div>
              </div>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.SNE_WALLET}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> StarkNet Engineering
                      Core Unit
                    </h3>
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.SH_WALLET}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Strategic Happiness
                      Core Unit
                    </h3>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.PE_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Protocol Engineering
                      Core Unit
                    </h3>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.ORA_MULTISIG}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.DAIF_WALLET}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Dai Foundation Core
                      Unit
                    </h3>
              ...
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  >
                    <h3 className="title">
                      <i className="fal fa-file-code"></i> Dai Foundation
                      Emergency Fund
                    </h3>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/address/${props.hat}#code`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.BAT}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.USDC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.WBTC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.AAVE}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.TUSD}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.KNC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.ZRX}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RENBTC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.MANA}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.PAXUSD}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.USDT}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.COMP}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.LRC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.LINK}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.BAL}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.YFI}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.GUSD}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNI}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.MATIC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.ADAI}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2DAIETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2WBTCETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2USDCETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2DAIUSDC}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2LINKETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2UNIETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2WBTCDAI}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.UNIV2AAVEETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.GUNIV3DAIUSDC1}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.GUNIV3DAIUSDC2}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA001}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA002}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA003}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA004}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA005}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.RWA006}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.WSTETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  <a
                    href={`https://etherscan.io/token/${props.CRVV1ETHSTETH}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h3 className="title">
