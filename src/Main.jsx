...
const Main = (props) => {
  ...
  document.title = `${formatNoDecimals.format(props.debt)} - USXD Stats`;
              ...
              <div className="column">
                <div className="box has-text-centered">
                  <CollateralChart
                    ...
                    useValue={true}
                  />
                  <h4 className="subtitle is-size-4">USXD Collateralization</h4>
                </div>
              </div>
              <div className="column">
                <div className="box has-text-centered">
            ...
            <div className="columns">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  {/*<p className="title subtitle is-size-6" title={props.vice}>Total Unbacked USXD (vice): {formatAmount.format(props.vice)}</p>*/}
                </div>
              </div>
              <div className="column">
                <div className="box has-text-centered">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p
                    ...
                    title="Aggregate USXD collection target of all active auctions across all collateral types"
                  >
                    {/*t('daistats.Dirt')*/}Total Unbacked USXD including
                    Penalties (Dirt)
                  </p>
            ...
            <div className="columns">
              ...
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="title subtitle is-size-4">
                    {/*t('daistats.flash_loan_limit')*/}USXD Flash Loan Limit
                  </p>
                  <p className="subtitle is-size-6">
                    {/*t('daistats.fee')}*/}Fee:{" "}
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="subtitle is-size-4">
                    {t("daistats.token_supply", { token: "USXD (ERC20)" })} (
