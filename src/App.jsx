...
add["SES_PERMANENT_TEAM_MULTISIG"] =
  "0xb5eB779cE300024EDB3dF9b6C007E312584f6F4f";
add["SES_INCUBATION_PROGRAM_MULTISIG"] =
  "0x7c09Ff9b59BAAebfd721cbDA3676826aA6d7BaE8";
add["SES_GRANTS_PROGRAM_MULTISIG"] =
...
add["MCD_JOIN_DIRECT_AAVEV2_DAI_STABLE"] =
  "0x778a13d3eeb110a4f7bb6529f99c000119a08e92";
add["MCD_JOIN_DIRECT_AAVEV2_DAI_VARIABLE"] =
  "0x6c3c78838c761c6ac7be9f59fe808ea2a6e4379d";
add["MCD_JOIN_DIRECT_AAVEV2_DAI_POOL"] =
...
const d3mAdai = build(
  add.MCD_JOIN_DIRECT_AAVEV2_DAI,
  "DssDirectDepositAaveDai"
);
const aaveIncentive = build(
  add.MCD_JOIN_DIRECT_AAVEV2_DAI_INCENTIVE,
...
class App extends Component {
  ...
  all = async (blockNumber) => {
    let p1 = multi.callStatic.aggregate(
      [
        ...
        [
          add.MCD_GOV,
          mkr.interface.encodeFunctionData("balanceOf", [add.GEM_PIT]),
        ],
        [
          add.MCD_DAI,
          dai.interface.encodeFunctionData("balanceOf", [add.UNISWAP_DAI]),
        ],
        [
          add.MCD_DAI,
          dai.interface.encodeFunctionData("balanceOf", [add.OASIS_DEX]),
        ],
        [
          add.MCD_DAI,
          dai.interface.encodeFunctionData("balanceOf", [add.BALANCER_V2]),
        ],
        [
          add.MCD_DAI,
          dai.interface.encodeFunctionData("balanceOf", [
            add.OPTIMISTIC_L1ESCROW,
          ]),
        ],
        ...
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI,
          d3mAdai.interface.encodeFunctionData("calculateTargetSupply", [
            ethers.BigNumber.from("35000000000000000000000000"),
          ]),
        ],
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI,
          d3mAdai.interface.encodeFunctionData("bar", []),
        ],
        [
          add.MCD_DAI,
          dai.interface.encodeFunctionData("balanceOf", [add.ADAI]),
        ],
        [
          add.MCD_VAT,
          vat.interface.encodeFunctionData("urns", [
            d3madaiIlkBytes,
            add.MCD_JOIN_DIRECT_AAVEV2_DAI,
          ]),
        ],
        ...
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI_VARIABLE,
          adai.interface.encodeFunctionData("totalSupply", []),
        ],
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI_STABLE,
          adai.interface.encodeFunctionData("totalSupply", []),
        ...
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI_POOL,
          aaveLendingPool.interface.encodeFunctionData("getReserveData", [
            add.MCD_DAI,
          ]),
        ],
        [
          add.MCD_JOIN_DIRECT_AAVEV2_DAI_INCENTIVE,
          aaveIncentive.interface.encodeFunctionData("getRewardsBalance", [
            [add.ADAI],
            add.MCD_JOIN_DIRECT_AAVEV2_DAI,
          ]),
        ],
        ...
        .concat(
          this.getIlkCall(ethAIlkBytes, "ETH_A", weth, add.ETH, add.PIP_ETH)
        )
        .concat(
          this.getIlkCall(batIlkBytes, "BAT_A", bat, add.BAT, add.PIP_BAT)
        )
        .concat(
          this.getIlkCall(usdcAIlkBytes, "USDC_A", usdc, add.USDC, add.PIP_USDC)
        )
        .concat(
          this.getIlkCall(wbtcAIlkBytes, "WBTC_A", wbtc, add.WBTC, add.PIP_WBTC)
        )
        .concat(
          this.getIlkCall(wbtcBIlkBytes, "WBTC_B", wbtc, add.WBTC, add.PIP_WBTC)
        )
        .concat(
          this.getIlkCall(wbtcCIlkBytes, "WBTC_C", wbtc, add.WBTC, add.PIP_WBTC)
        )
        .concat(
          this.getIlkCall(usdcBIlkBytes, "USDC_B", usdc, add.USDC, add.PIP_USDC)
        )
        .concat(
          this.getIlkCall(tusdAIlkBytes, "TUSD_A", tusd, add.TUSD, add.PIP_TUSD)
        )
        .concat(
          this.getIlkCall(kncAIlkBytes, "KNC_A", knc, add.KNC, add.PIP_KNC)
        )
        .concat(
          this.getIlkCall(zrxAIlkBytes, "ZRX_A", zrx, add.ZRX, add.PIP_ZRX)
        )
        .concat(
          this.getIlkCall(manaAIlkBytes, "MANA_A", mana, add.MANA, add.PIP_MANA)
        )
        .concat(
          this.getIlkCall(
            paxAIlkBytes,
        ...
        .concat(
          this.getIlkCall(usdtAIlkBytes, "USDT_A", usdt, add.USDT, add.PIP_USDT)
        )
        .concat(
          this.getIlkCall(compAIlkBytes, "COMP_A", comp, add.COMP, add.PIP_COMP)
        )
        .concat(
          this.getIlkCall(lrcAIlkBytes, "LRC_A", lrc, add.LRC, add.PIP_LRC)
        )
        .concat(
          this.getIlkCall(linkAIlkBytes, "LINK_A", link, add.LINK, add.PIP_LINK)
        )
        .concat(
          this.getIlkCall(ethBIlkBytes, "ETH_B", weth, add.ETH, add.PIP_ETH)
        )
        .concat(
          this.getIlkCall(balAIlkBytes, "BAL_A", bal, add.BAL, add.PIP_BAL)
        )
        .concat(
          this.getIlkCall(yfiAIlkBytes, "YFI_A", yfi, add.YFI, add.PIP_YFI)
        )
        .concat(
          this.getIlkCall(gusdAIlkBytes, "GUSD_A", gusd, add.GUSD, add.PIP_GUSD)
        )
        .concat(
          this.getIlkCall(uniAIlkBytes, "UNI_A", uni, add.UNI, add.PIP_UNI)
        )
        .concat(
          this.getIlkCall(
            renbtcAIlkBytes,
        ...
        .concat(
          this.getIlkCall(aaveAIlkBytes, "AAVE_A", aave, add.AAVE, add.PIP_AAVE)
        )
        .concat(
          this.getIlkCall(
            univ2daiethAIlkBytes,
            "UNIV2DAIETH_A",
            univ2daieth,
            add.UNIV2DAIETH,
            add.PIP_UNIV2DAIETH
        ...
        .concat(
          this.getIlkCall(
            univ2wbtcethAIlkBytes,
            "UNIV2WBTCETH_A",
            univ2wbtceth,
            add.UNIV2WBTCETH,
            add.PIP_UNIV2WBTCETH
          )
        )
        .concat(
          this.getIlkCall(
            univ2usdcethAIlkBytes,
            "UNIV2USDCETH_A",
            univ2usdceth,
            add.UNIV2USDCETH,
            add.PIP_UNIV2USDCETH
          )
        )
        .concat(
          this.getIlkCall(
            univ2daiusdcAIlkBytes,
            "UNIV2DAIUSDC_A",
            univ2daiusdc,
            add.UNIV2DAIUSDC,
            add.PIP_UNIV2DAIUSDC
          )
        )
        .concat(
          this.getIlkCall(
            univ2linkethAIlkBytes,
            "UNIV2LINKETH_A",
            univ2linketh,
            add.UNIV2LINKETH,
            add.PIP_UNIV2LINKETH
          )
        )
        .concat(
          this.getIlkCall(
            univ2uniethAIlkBytes,
            "UNIV2UNIETH_A",
            univ2unieth,
            add.UNIV2UNIETH,
            add.PIP_UNIV2UNIETH
        ...
        .concat(
          this.getIlkCall(
            univ2wbtcdaiAIlkBytes,
            "UNIV2WBTCDAI_A",
            univ2wbtcdai,
            add.UNIV2WBTCDAI,
            add.PIP_UNIV2WBTCDAI
          )
        )
        .concat(
          this.getIlkCall(
            univ2aaveethAIlkBytes,
            "UNIV2AAVEETH_A",
            univ2aaveeth,
            add.UNIV2AAVEETH,
            add.PIP_UNIV2AAVEETH
          )
        )
        .concat(
          this.getIlkCall(ethCIlkBytes, "ETH_C", weth, add.ETH, add.PIP_ETH)
        )
        .concat(
          this.getRwaIlkCall(
            rwa001AIlkBytes,
        ...
        .concat(
          this.getIlkCall(
            crvv1ethstethAIlkBytes,
            "CRVV1ETHSTETH_A",
            crvv1ethsteth,
            add.CRVV1ETHSTETH,
            add.PIP_CRVV1ETHSTETH
          )
        ),
    ...
    const gemPit = mkr.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    const uniswapDai = dai.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    const oasisDexDai = dai.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    const balancerV2Dai = dai.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    const optimisticDaiSupply = dai.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    ...
    const chaiSupply = chai.interface.decodeFunctionResult(
      "totalSupply",
      res[offset++]
    )[0];
    ...
    const bkrSupply = bkr.interface.decodeFunctionResult(
      "totalSupply",
      res[offset++]
    )[0];
    const mkrBroken = mkr.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    ...
    const d3mAdaiTargetSupply = d3mAdai.interface.decodeFunctionResult(
      "calculateTargetSupply",
      res[offset++]
    )[0];
    const d3mAdaiBar = d3mAdai.interface.decodeFunctionResult(
      "bar",
      res[offset++]
    )[0];
    const d3mAdaiAvailableLiquidity = dai.interface.decodeFunctionResult(
      "balanceOf",
      res[offset++]
    )[0];
    const d3mAdaiDaiDebt = vat.interface.decodeFunctionResult(
      "urns",
      res[offset++]
    )[1];
    const d3mAdaiTotalSupplyVariable = adai.interface.decodeFunctionResult(
      "totalSupply",
      res[offset++]
    )[0];
    const d3mAdaiTotalSupplyFixed = adai.interface.decodeFunctionResult(
      "totalSupply",
      res[offset++]
    )[0];
    ...
    const d3mAdaiReserve = aaveLendingPool.interface.decodeFunctionResult(
      "getReserveData",
      res[offset++]
    )[0];
    const d3mAdaiIncentive = aaveIncentive.interface.decodeFunctionResult(
      "getRewardsBalance",
      res[offset++]
    )[0];
    const lerpHumpStart = lerp.interface.decodeFunctionResult(
      "start",
      res[offset++]
    )[0];
    const lerpHumpEnd = lerp.interface.decodeFunctionResult(
      "end",
      res[offset++]
    )[0];
    const lerpHumpStartTime = lerp.interface.decodeFunctionResult(
      "startTime",
      res[offset++]
    )[0];
    const lerpHumpDuration = lerp.interface.decodeFunctionResult(
      "duration",
      res[offset++]
    )[0];
    ...
    const ilks = [
      ...
      this.getIlkMap(
        ...
        DP10,
        DP7
      ), // NOTE this dsValue is also shown for TUSD, USDP, GUSD, aDAI
      this.getIlkMap(
        res,
        (offset += ILK_CALL_COUNT),
        "WBTC",
    ...
    const d3mAdaiFeesPending =
      ilksByName["DIRECT-AAVEV2-DAI"].lockedBn.sub(d3mAdaiDaiDebt);
    const d3mAdaiTotalSupply = d3mAdaiAvailableLiquidity.add(
      d3mAdaiTotalSupplyVariable.add(d3mAdaiTotalSupplyFixed)
    );
    const d3mAdaiAdjustment = d3mAdaiTargetSupply.sub(d3mAdaiTotalSupply);
    const lerpHumpCurrent = this.getLerp(
      lerpHumpStart,
      lerpHumpEnd,
      lerpHumpStartTime,
      lerpHumpDuration,
    ...
    this.setState((state) => {
      return {
        ...
        d3mAdaiAvailableLiquidity: utils.formatUnits(
        ...
        d3mAdaiTotalSupplyVariable: utils.formatUnits(
        ...
        d3mAdaiDepositAPR: utils.formatUnits(
          d3mAdaiReserve.currentLiquidityRate,
          27
        ),
        d3mAdaiVariableBorrowAPR: utils.formatUnits(
          d3mAdaiReserve.currentVariableBorrowRate,
          27
        ),
        d3mAdaiStableBorrowAPR: utils.formatUnits(
          d3mAdaiReserve.currentStableBorrowRate,
          27
        ),
        ...
        lerpHumpAdjustment: utils.formatUnits(
  ...
  getIlkCall = (ilkBytes, ilkSuffix, gem, gemAdd, pipAdd) => {
    ...
    if (gem === crvv1ethsteth) {
      lockedCall = [
        gemJoinAdd,
        cropJoin.interface.encodeFunctionData("total", []),
      ];
    } else {
      lockedCall = [
        gemAdd,
  ...
  getRwaIlkCall = (ilkBytes, ilkSuffix, gem, gemAdd, pipAdd) => {
    ...
    return [
      ...
      [
        add.MCD_DAI,
        gem.interface.encodeFunctionData("balanceOf", [conduitInAdd]),
      ],
      [
        add.MCD_DAI,
        gem.interface.encodeFunctionData("balanceOf", [conduitOutAdd]),
      ],
      [
        add.ILK_REGISTRY,
        ilkRegistry.interface.encodeFunctionData("name", [ilkBytes]),
      ],
    ];
  };
  ...
  getRwaIlkMap = (res, idx, token, ilkName, gem, units, base) => {
    ...
    const locked = gem.interface.decodeFunctionResult(
      "balanceOf",
      res[idx++]
    )[0];
    const conduitIn = gem.interface.decodeFunctionResult(
      "balanceOf",
      res[idx++]
    )[0];
    const conduitOut = gem.interface.decodeFunctionResult(
      "balanceOf",
      res[idx++]
    )[0];
    ...
    return {
      ...
      value: utils.formatUnits(
        locked.mul(ethers.BigNumber.from(price).mul(DP10)),
        45
      ),
  ...
  getPsmIlkMap = (res, idx, token, ilkName, psm, dp, tokenDp, priceDp) => {
    ...
    const ilk = vat.interface.decodeFunctionResult("ilks", res[idx++]);
    const locked = usdc.interface.decodeFunctionResult(
      "balanceOf",
      res[idx++]
    )[0];
    ...
    const supply = usdc.interface.decodeFunctionResult(
      "totalSupply",
      res[idx++]
    )[0];
  ...
  getMKRAnnualBurn = (
    ...
    const daiFromETH =
      utils.formatEther(ethIlk.Art) * utils.formatUnits(ethIlk.rate, 27);
    const stabilityETH = ethFee / 100;
    const daiFromETHB =
      utils.formatEther(ethBIlk.Art) * utils.formatUnits(ethBIlk.rate, 27);
    const stabilityETHB = ethBFee / 100;
    const daiFromBAT =
      utils.formatEther(batIlk.Art) * utils.formatUnits(batIlk.rate, 27);
    const stabilityBAT = batFee / 100;
    const daiFromWBTC =
      utils.formatEther(wbtcIlk.Art) * utils.formatUnits(wbtcIlk.rate, 27);
    const stabilityWBTC = wbtcFee / 100;
    const daiFromUSDC =
      utils.formatEther(usdcIlk.Art) * utils.formatUnits(usdcIlk.rate, 27);
    const stabilityUSDC = usdcFee / 100;
    const daiFromUSDCB =
      utils.formatEther(usdcBIlk.Art) * utils.formatUnits(usdcBIlk.rate, 27);
    const stabilityUSDCB = usdcBFee / 100;
    const daiFromTUSD =
      utils.formatEther(tusdIlk.Art) * utils.formatUnits(tusdIlk.rate, 27);
    const stabilityTUSD = tusdFee / 100;
    const daiFromKNCA =
      utils.formatEther(kncAIlk.Art) * utils.formatUnits(kncAIlk.rate, 27);
    const stabilityKNCA = kncAFee / 100;
    const daiFromZRXA =
      utils.formatEther(zrxAIlk.Art) * utils.formatUnits(zrxAIlk.rate, 27);
    const stabilityZRXA = zrxAFee / 100;
    const daiFromMANAA =
      utils.formatEther(manaAIlk.Art) * utils.formatUnits(manaAIlk.rate, 27);
    const stabilityMANAA = manaAFee / 100;
    const daiFromPAXA =
      utils.formatEther(paxAIlk.Art) * utils.formatUnits(paxAIlk.rate, 27);
    const stabilityPAXA = paxAFee / 100;
    const daiFromUSDTA =
      utils.formatEther(usdtAIlk.Art) * utils.formatUnits(usdtAIlk.rate, 27);
    const stabilityUSDTA = usdtAFee / 100;
    const daiFromCOMPA =
      utils.formatEther(compAIlk.Art) * utils.formatUnits(compAIlk.rate, 27);
    const stabilityCOMPA = compAFee / 100;
    const daiFromLRCA =
      utils.formatEther(lrcAIlk.Art) * utils.formatUnits(lrcAIlk.rate, 27);
    const stabilityLRCA = lrcAFee / 100;
    const daiFromLINKA =
      utils.formatEther(linkAIlk.Art) * utils.formatUnits(linkAIlk.rate, 27);
