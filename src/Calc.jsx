        ...
        <div className="container">
          ...
          <div className="columns">
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-4">
                  Dai from ETH (
                  {formatAmount.format((props.ilks[0].Art / props.debt) * 100)}
                  %)
                </p>
              </div>
            </div>
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-4">
                  Dai from BAT (
                  {formatAmount.format((props.ilks[1].Art / props.debt) * 100)}
                  %)
                </p>
              </div>
            </div>
            ...
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-6">
                  ETH Supply Locked:{" "}
                  {formatPercent.format(props.ethLocked / props.ethSupply)}
                </p>
              </div>
            </div>
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-6">
                  Utilization:{" "}
                  {formatAmount.format(
                    (props.ilks[0].Art / props.ilks[0].line) * 100
                  )}
                  %
                </p>
              </div>
          ...
          <div className="columns">
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-6">
                  BAT Supply Locked:{" "}
                  {formatPercent.format(props.batLocked / props.batSupply)}
                </p>
              </div>
            </div>
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-6">
                  Utilization:{" "}
                  {formatAmount.format(
                    (props.ilks[1].Art / props.ilks[1].line) * 100
                  )}
                  %
                </p>
              </div>
          ...
          <div className="columns">
            <div className="column">
              <div className="box has-text-centered">
                ...
                <p className="subtitle is-size-6">
                  Surplus Buffer: {formatAmount.format(props.surplusBuffer)}
                </p>
              </div>
            </div>
            <div className="column">
          ...
          <div className="columns">
            <div className="column">
              <div className="box has-text-centered">
                <a
                  href={`https://etherscan.io/token/${props.MCD_DAI}`}
                  target="_blank"
            ...
            <div className="column">
              <div className="box has-text-centered">
                <a
                  href={`https://etherscan.io/token/${props.SAI}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <h3 className="title">
            ...
            <div className="column">
              <div className="box has-text-centered">
                <a
                  href={`https://etherscan.io/token/${props.MCD_GOV}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <h3 className="title">
